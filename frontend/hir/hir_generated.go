...
func (n *LoopStmt) Pos() Position    { return n.Pos_ }
func (n *LoopStmt) End() Position    { return n.End_ }
...
func (n *MapInsertStmt) Pos() Position    { return n.Pos_ }
func (n *MapInsertStmt) End() Position    { return n.End_ }
func (n *MapInsertStmt) Accept(v Visitor) { v.VisitMapInsertStmt(n) }
func (n *MapInsertStmt) stmtNode()        {}
...
func (n *MapReadExpr) Pos() Position    { return n.Pos_ }
...
func (n *StringLiteral) isOperand()       {}
...
func (n *VariantDiscriminantExpr) Pos() Position    { return n.Pos_ }
func (n *VariantDiscriminantExpr) End() Position    { return n.End_ }
func (n *VariantDiscriminantExpr) Accept(v Visitor) { v.VisitVariantDiscriminantExpr(n) }
func (n *VariantDiscriminantExpr) exprNode()        {}
...
func (n *VariantReadExpr) Pos() Position    { return n.Pos_ }
func (n *VariantReadExpr) End() Position    { return n.End_ }
func (n *VariantReadExpr) Accept(v Visitor) { v.VisitVariantReadExpr(n) }
func (n *VariantReadExpr) exprNode()        {}
...
func (n *VecReadExpr) Pos() Position    { return n.Pos_ }
func (n *VecReadExpr) End() Position    { return n.End_ }
func (n *VecReadExpr) Accept(v Visitor) { v.VisitVecReadExpr(n) }
func (n *VecReadExpr) exprNode()        {}
...
func (n *VecWriteStmt) Pos() Position    { return n.Pos_ }
func (n *VecWriteStmt) End() Position    { return n.End_ }
func (n *VecWriteStmt) Accept(v Visitor) { v.VisitVecWriteStmt(n) }
func (n *VecWriteStmt) stmtNode()        {}
...
type Visitor interface {
	...
	VisitVariantDiscriminantExpr(n *VariantDiscriminantExpr)
	VisitVariantLiteral(n *VariantLiteral)
	VisitVariantReadExpr(n *VariantReadExpr)
	VisitVecLiteral(n *VecLiteral)
	VisitVecPushStmt(n *VecPushStmt)
	VisitVecReadExpr(n *VecReadExpr)
	VisitVecWriteStmt(n *VecWriteStmt)
