...
static_assert(offsetof(Vector, elem_size) == 16, "ABI Mismatch: Vector.elem_size offset must be 16");
...
static_assert(offsetof(Map, tombstone_count) == 12, "ABI Mismatch: Map.tombstone_count offset must be 12");
...
static_assert(offsetof(Map, is_string_key) == 24, "ABI Mismatch: Map.is_string_key offset must be 24");

static_assert(sizeof(Ref) == 16, "ABI Mismatch: Ref must be 16 bytes");
static_assert(alignof(Ref) == 8, "ABI Mismatch: Ref align must be 8");

// 2. Verify Offsets for Ref
static_assert(offsetof(Ref, ptr) == 0, "ABI Mismatch: Ref.ptr offset must be 0");
static_assert(offsetof(Ref, refcount) == 8, "ABI Mismatch: Ref.refcount offset must be 8");
