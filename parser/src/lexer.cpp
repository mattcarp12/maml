...
Token Lexer::nextToken()
{
    ...
    case '"':
        ...
        tok.pos = { .filename = filename_,
            .line = static_cast<uint32_t>(startLine),
            .col = static_cast<uint32_t>(startCol) };
...
{
    // Newlines are skipped entirely just like spaces and tabs
...
{
    return { .type = type,
        .literal = input_.substr(position_, len),
